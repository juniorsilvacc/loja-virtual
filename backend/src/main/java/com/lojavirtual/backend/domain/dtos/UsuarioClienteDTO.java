...
public class UsuarioClienteDTO implements Serializable {
  ...
  public UsuarioClienteDTO(Integer id, String nome, String cpf, String email, Endereco endereco) {
    this.id = id;
    this.nome = nome;
    this.cpf = cpf;
    this.email = email;
  ...
  public Usuario converter(UsuarioClienteDTO usuarioClienteDTO){
    Usuario usuario = new Usuario();
    BeanUtils.copyProperties(usuarioClienteDTO, usuario);
    return usuario;
  }
